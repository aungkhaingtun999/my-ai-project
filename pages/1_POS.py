...
# ==========================================
# 1. PATH FIXING: utils ကို ရှာတွေ့အောင် လုပ်ခြင်း
# ==========================================
# Root directory ကို ရှာပြီး path ထဲသို့ ထည့်ခြင်း
root_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
if root_dir not in sys.path:
    sys.path.append(root_dir)

# ==========================================
# 2. IMPORTS (Safe Import)
# ==========================================
from database import get_products, checkout_sale_rpc
from auth import is_authenticated

# utils မှ import လုပ်ခြင်း (Error တက်ပါက သတိပေးချက်ပြမည်)
try:
    from utils.thermal_receipt import print_thermal
    from utils.receipt_pdf import generate_pdf
except ImportError as e:
    st.error(f"Import Error: {e}. 'utils' folder ထဲတွင် '__init__.py' ဖိုင်ရှိမရှိ စစ်ဆေးပါ။")
    st.stop()
