...
@dataclass
class ERPContext:
    current_user: Optional[Dict[str, Any]] = None if "Dict" in globals() else None
    ...
    language: str = "en"
    current_transaction_id: str = field(default_factory=generate_tx_id)
    ...
    def rotate_transaction(self): self.current_transaction_id = generate_tx_id()
