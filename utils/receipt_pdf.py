...
def generate_pdf(data):
    try:
        ...
        invoice_no = receipt.get("invoice_no") or receipt.get("receipt_no") or receipt.get("invoice") or "INV-PENDING"
        date_str = receipt.get("date") or receipt.get("timestamp") or receipt.get("sale_date") or "N/A"
        cashier = receipt.get("cashier") or receipt.get("cashier_name") or "Admin"
        subtotal = num(receipt.get("subtotal") or receipt.get("sub_total"))
        ...
        grand_total = num(receipt.get("grand_total") or receipt.get("total"))
        ...
        pdf.drawRightString(550, y - 10, f"GRAND TOTAL : {grand_total:,.0f} MMK")
